...
export const EMAIL_REG_EXP = /^[A-Z\d+_.-]+@[A-Z\d.-]{5,320}$/i;
export const HOUSE_NBR_REG_EXP = /^\d[/ \-+\da-zA-Z]{0,50}$/; // No special characters allowed
export const PHONE_REG_EXP = /^[0+][\d \-()]{6,50}$/; // Starts with 0 or +, followed by 7-15 digits
...
export const NAME_REG_EXP = /^[^@\\*?$|=´'"[\]{}<>\d]{0,100}$/; // from https://wiki.gematik.de/x/JRlpGw
